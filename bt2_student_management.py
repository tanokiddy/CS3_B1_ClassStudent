...
class Course:
    def __init__(self, course_id: int, course_name: str, type: COURSE_TYPE, tuition: int) -> None:
...
class Student:
    def __init__(self, student_id: int, student_name: str, dob: str) -> None:
        self.courses = []
...
# Get list student_1's all registered courses
